...
@Component({
  selector: 'app-ans-detail2',
  templateUrl: './ans-detail2.component.html',
  styleUrls: ['./ans-detail2.component.css']
})
export class AnsDetail2Component implements OnInit {
  options: any[] = [];
  ...
  getTickets() {
    this.tickets = this.shared.setTicketsAnsNoSucc();
